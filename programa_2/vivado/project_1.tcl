...
#
# Generated by Vivado on Sat Jul 02 07:16:08 -05 2022
...
#
#    "/home/josue/Documentos/GitHub/proyecto-especializacion-final/programa_2/vivado/project_1/project_1.srcs/sources_1/new/red.v"
#
...
set files [list \
 [file normalize "${origin_dir}/project_1/project_1.srcs/sources_1/new/red.v" ]\
]
...
set_property -name "top" -value "red" -objects $obj
set_property -name "top_file" -value "$proj_dir/project_1.srcs/sources_1/new/red.v" -objects $obj
...
if { [get_files red.v] == "" } {
  import_files -quiet -fileset sources_1 /home/josue/Documentos/GitHub/proyecto-especializacion-final/programa_2/vivado/project_1/project_1.srcs/sources_1/new/red.v
}
...
# red
  ...
  set block_name red
  set block_cell_name red_0
  if { [catch {set red_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins red_0/s00_axi]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins red_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins red_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs red_0/s00_axi/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.371698",
   "Default View_TopLeft":"-118,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1040 -y 370 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1040 -y 390 -defaultsOSRD
preplace port btns_4bits -pg 1 -lvl 4 -x 1040 -y 220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 420 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 900 -y 220 -defaultsOSRD
preplace inst red_0 -pg 1 -lvl 3 -x 900 -y 80 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 610 -y 210 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 230 -y 210 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 100 450 70 780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 110 430
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 60 760
...
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 460 130n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 200
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 770 60n
levelinfo -pg 1 0 230 610 900 1040
pagesize -pg 1 -db -bbox -sgen 0 0 1170 540
"
}
